...
//Player account
pub const MAX_PLAYER_SIZE: usize = FLOAT_MAX + 1 + (1+FLOAT_MAX) + DISCRIMINATOR + FLOAT_MAX + PUBKEY_MAX; //u64 + u8 + rating wrapped in some + discriminator for Player account + claimable i64 + pubkey
