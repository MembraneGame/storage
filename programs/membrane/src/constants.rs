...
//Player account
pub const MAX_PLAYER_SIZE: usize = PUBKEY_MAX + (1+FLOAT_MAX) + DISCRIMINATOR + FLOAT_MAX; //pubkey + rating wrapped in some + discriminator for Player account + claimable i64
